...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* --------- بناء عناصر الإشعارات مرة واحدة --------- */
  buildNotifList();
  ...
  /* ---------- AJAX لتحديث read_at ---------- */
  function markAsRead() {
    if (badge.classList.contains('hidden')) return;   // تمّت القراءة من قبل
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // إغلاق بعد وقت قصير من مغادرة الماوس
  ...
  // إغلاق إذا تم النقر في مكان آخر
  document.addEventListener('click', () => {
    if (avatarOpen) {
      dropdown.style.display = 'none';
      avatarOpen = false;
